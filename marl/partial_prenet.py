...
from utils.folder import SimImagePreloader, partial_sim_loader2
...
dataset_name = 'partial_intelligent_bfs'
...
image_datasets = {'train': SimImagePreloader(data_dir + 'train/', train_csv, loader=partial_sim_loader2),
                    'test': SimImagePreloader(data_dir + 'test/', test_csv, loader=partial_sim_loader2)}
